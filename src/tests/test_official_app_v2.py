...
from listgrok.parsers.official_app_v2 import (
    _parse_faction_block,
    build_tree,
    parse_official_app_v2,
    parse_unit_block,
)
...
class TestParseOfficialAppV2:
    def test_dialect_a_official_1(self):
        army_list = parse_official_app_v2((EXAMPLES / "official_1.txt").read_text())
    ...
    def test_dialect_b_official_7(self):
        army_list = parse_official_app_v2((EXAMPLES / "official_7.txt").read_text())
...
class TestAllOfficialExamples:
    ...
    def test_metadata(self, filename):
        ...
        army_list = parse_official_app_v2((EXAMPLES / filename).read_text())
